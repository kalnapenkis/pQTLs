...
run.eqtl <- function(cnv.file = "/path/to/EGCUT_CN_freqfilter_unique.RDS",
...
p.value.correction.main <- function(eqtl.file = "/path/to/eqtl_pvalues_theshold_1e-3.txt",
                                    min.permut.pvalues.file = "/path/to/eqtl_permutations_min_pvalue.RDS",
                                    cores = 40) {
  require(parallel)
  require(dplyr)
  require(ismev)
...
p.value.correction.min <- function(min.pv.file = "/path/to/eqtl_min_pvalues.RDS",
                                   min.permut.pvalues.file = "/path/to/eqtl_permutations_min_pvalue.RDS",
                                   cores = 40) {
  require(parallel)
  require(ismev)
